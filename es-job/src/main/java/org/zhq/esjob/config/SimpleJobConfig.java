...
public class SimpleJobConfig {
    ...
    @Autowired
    public SimpleJobConfig(ZookeeperRegistryCenter registryCenter, JobEventConfiguration jobEventConfiguration) {
    ...
    private LiteJobConfiguration getLiteJobConfiguration(Class<? extends SimpleJob> jobClass, String cron, int shardingTotalCount, String shardingItemParameters, String jobParameter, boolean failover, boolean monitorExecution, int monitorPort, int maxTimeDiffSeconds, String jobShardingStrategyClass) {
